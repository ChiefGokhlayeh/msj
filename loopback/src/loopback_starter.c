/***********************************************************************
  loopback_starter.c, important remarks via "Svg" and "MSJ"
  ...
  Corrections/extensions
    ...
    13-Mar-22   revised for DAC in NON-EDMA Mode (see Email A. Klemenz 10-Sep-20)
...
// Svg gemaess A. Klemenz 10-Sep-20 raus
...
// ###################################################################
//------------- END OF MSJ declaration section -----------------------
// ###################################################################
...
// Das Array-Element "int ADDA8M12_adc[0][0]" (32 bit( enthält sowohl die Samples des linken als auch des rechten Kanals.
...
void edma_int(void)
{
  ...
  for (indx = 0; indx < ADDA8M12_BUFSIZE; indx++)
  {
    ...
    // Die oberen 16 Bits enthalten also Nullen, der rechte Kanal enthält also nur Nullen
...
int main(void)
{
  ...
  *******************************************************************/
  ADDA8M12->config = ADDA8M12_ADCCLKINT | ADDA8M12_INTCLK2M | ADDA8M12_DACCLKADC;
...
#ifdef USE_DAC_EDMA_C6747
  DM2_intMap(DM2_INTEVT_INT1, DM2_INTGP5_10); // Svg gemaess A. Klemenz 10-Sep-20 raus
#endif
  ...
  *******************************************************************/
...
#ifdef USE_DAC_EDMA_C6747
  memset(ADDA8M12_dac, 0, sizeof(ADDA8M12_dac)); // Svg gemaess A. Klemenz 10-Sep-20 raus
#endif
...
#ifdef USE_DAC_EDMA_C6747
  // DAC-Seite : Svg gemaess A. Klemenz 10-Sep-20 raus
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT5].OPT =
      edma3cc0Regs->PARAMSET[102].OPT =
          edma3cc0Regs->PARAMSET[103].OPT =
              CSL_FMK(EDMA3CC_OPT_PRIVID, 0) | CSL_FMKT(EDMA3CC_OPT_ITCCHEN, DISABLE) | CSL_FMKT(EDMA3CC_OPT_TCCHEN, DISABLE) | CSL_FMKT(EDMA3CC_OPT_ITCINTEN, DISABLE) | CSL_FMKT(EDMA3CC_OPT_TCINTEN, ENABLE) | CSL_FMK(EDMA3CC_OPT_TCC, CSL_EDMA3_CHA_GPIO_BNKINT5) | CSL_FMKT(EDMA3CC_OPT_TCCMOD, NORMAL) | CSL_FMKT(EDMA3CC_OPT_FWID, 32BIT) // don't care
              | CSL_FMKT(EDMA3CC_OPT_STATIC, NORMAL) | CSL_FMKT(EDMA3CC_OPT_SYNCDIM, ASYNC) | CSL_FMKT(EDMA3CC_OPT_DAM, INCR) | CSL_FMKT(EDMA3CC_OPT_SAM, INCR);
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT5].A_B_CNT =
      edma3cc0Regs->PARAMSET[102].A_B_CNT =
          edma3cc0Regs->PARAMSET[103].A_B_CNT =
              CSL_FMK(EDMA3CC_A_B_CNT_BCNT, ADDA8M12_BUFSIZE) | CSL_FMK(EDMA3CC_A_B_CNT_ACNT, 4);
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT5].SRC_DST_BIDX =
      edma3cc0Regs->PARAMSET[102].SRC_DST_BIDX =
          edma3cc0Regs->PARAMSET[103].SRC_DST_BIDX =
              CSL_FMK(EDMA3CC_SRC_DST_BIDX_SRCBIDX, 4) | CSL_FMK(EDMA3CC_SRC_DST_BIDX_DSTBIDX, 0);
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT5].SRC_DST_CIDX =
      edma3cc0Regs->PARAMSET[102].SRC_DST_CIDX =
          edma3cc0Regs->PARAMSET[103].SRC_DST_CIDX =
              CSL_FMK(EDMA3CC_SRC_DST_CIDX_SRCCIDX, 0) | CSL_FMK(EDMA3CC_SRC_DST_CIDX_DSTCIDX, 0);

  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT5].LINK_BCNTRLD =
      edma3cc0Regs->PARAMSET[103].LINK_BCNTRLD =
          CSL_FMK(EDMA3CC_LINK_BCNTRLD_LINK, ((uint32_t)&edma3cc0Regs->PARAMSET[102] & 0xFFFF)) | CSL_FMK(EDMA3CC_LINK_BCNTRLD_BCNTRLD, ADDA8M12_BUFSIZE);
  edma3cc0Regs->PARAMSET[102].LINK_BCNTRLD =
      CSL_FMK(EDMA3CC_LINK_BCNTRLD_LINK, ((uint32_t)&edma3cc0Regs->PARAMSET[103] & 0xFFFF)) | CSL_FMK(EDMA3CC_LINK_BCNTRLD_BCNTRLD, ADDA8M12_BUFSIZE);
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT2].OPT =
      edma3cc0Regs->PARAMSET[100].OPT =
          edma3cc0Regs->PARAMSET[101].OPT =
              CSL_FMK(EDMA3CC_OPT_PRIVID, 0) | CSL_FMKT(EDMA3CC_OPT_ITCCHEN, DISABLE) | CSL_FMKT(EDMA3CC_OPT_TCCHEN, DISABLE) | CSL_FMKT(EDMA3CC_OPT_ITCINTEN, DISABLE) | CSL_FMKT(EDMA3CC_OPT_TCINTEN, ENABLE) | CSL_FMK(EDMA3CC_OPT_TCC, CSL_EDMA3_CHA_GPIO_BNKINT2) | CSL_FMKT(EDMA3CC_OPT_TCCMOD, NORMAL) | CSL_FMKT(EDMA3CC_OPT_FWID, 32BIT) // don't care
              | CSL_FMKT(EDMA3CC_OPT_STATIC, NORMAL) | CSL_FMKT(EDMA3CC_OPT_SYNCDIM, ASYNC) | CSL_FMKT(EDMA3CC_OPT_DAM, INCR) | CSL_FMKT(EDMA3CC_OPT_SAM, INCR);
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT2].A_B_CNT =
      edma3cc0Regs->PARAMSET[100].A_B_CNT =
          edma3cc0Regs->PARAMSET[101].A_B_CNT =
              CSL_FMK(EDMA3CC_A_B_CNT_BCNT, ADDA8M12_BUFSIZE / 8) | CSL_FMK(EDMA3CC_A_B_CNT_ACNT, 4 * 8);
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT2].SRC_DST_BIDX =
      edma3cc0Regs->PARAMSET[100].SRC_DST_BIDX =
          edma3cc0Regs->PARAMSET[101].SRC_DST_BIDX =
              CSL_FMK(EDMA3CC_SRC_DST_BIDX_SRCBIDX, 0) | CSL_FMK(EDMA3CC_SRC_DST_BIDX_DSTBIDX, 4 * 8);
  ...
  edma3cc0Regs->PARAMSET[CSL_EDMA3_CHA_GPIO_BNKINT2].LINK_BCNTRLD =
      edma3cc0Regs->PARAMSET[100].LINK_BCNTRLD =
          CSL_FMK(EDMA3CC_LINK_BCNTRLD_LINK, ((uint32_t)&edma3cc0Regs->PARAMSET[101] & 0xFFFF)) | CSL_FMK(EDMA3CC_LINK_BCNTRLD_BCNTRLD, ADDA8M12_BUFSIZE / 8);
  edma3cc0Regs->PARAMSET[101].LINK_BCNTRLD =
      CSL_FMK(EDMA3CC_LINK_BCNTRLD_LINK, ((uint32_t)&edma3cc0Regs->PARAMSET[100] & 0xFFFF)) | CSL_FMK(EDMA3CC_LINK_BCNTRLD_BCNTRLD, ADDA8M12_BUFSIZE / 8);
  ...
  /* A, Klemenz 24-Mai-19
      Die Abtastfrequenz wird in main() eingestellt:
           ADDA8M12->config = ADDA8M12_ADCCLKINT
                            ...
                            | ADDA8M12_INT0ADC
                            | ADDA8M12_INT1DAC;
      Für den ADC haben Sie die Optionen
      ADDA8M12_INTCLK1M       1MHz
      ADDA8M12_INTCLK2M       2MHz
      ADDA8M12_INTCLK4M       4MHz, beim 6747 aber nur möglich wenn
                                     der DAC nicht benutzt wird,
                                     sonst kommt die EDMA nicht mehr mit
      ADDA8M12_INTCLK8M       8MHz, nicht möglich beim 6747
      ADDA8M12_ADCCLKEXT      Über die EXTCLK Buchse eingespeist
...
#ifdef USE_DAC_EDMA_C6747
  // EXT CLOCK
  ADDA8M12->config = ADDA8M12_ADCCLKINT | ADDA8M12_ADCCLKEXT // ADDA8M12_INTCLK2M // ADDA8M12_ADCCLKEXT // EXT_CLK: hier muss spaeter ADDA8M12_ADCCLKEXT stehen
                     | ADDA8M12_DACCLKADC | ADDA8M12_INT0ADC | ADDA8M12_INT1DAC;
#else
  ADDA8M12->config = ADDA8M12_ADCCLKINT | ADDA8M12_ADCCLKEXT // hier stand ADDA8M12_INTCLK2M
                     | ADDA8M12_DACCLKWRT                    // Svg gemaess A. Klemenz 10-Sep-20 statt ADDA8M12_DACCLKADC
                     | ADDA8M12_INT0ADC;
  //| ADDA8M12_INT1DAC;  // Svg gemaess A. Klemenz 10-Sep-20 statt ADDA8M12_DACCLKADC
#endif
  ...
  *******************************************************************/
  ...
  {
#if defined(USE_MSVC_ANSI_C_SIM) || defined(USE_GCC_ANSI_C_SIM)
    // der Interrupt muss hier natürlich manuell aufgeruden werden
...
// einzelne Samples fuer DAC LINKS und RECHTS zum DAC ..
        ...
        // Bei Bedarf: Kopieren von links nach rechts, wenn man nur einen Eingang benutzt
        //              ADDA8M12_DAC_data.channel[RIGHT] = ADDA8M12_ADC_data.channel[LEFT];
        ADDA8M12_dac[ADDA8M12_bufferReady][indx] = ADDA8M12_DAC_data.both;
#else
        // write to DAC, ACHTUNG : nur down-gesampelte Signale zum DAC !! KEIN EDMA am DAC mehr
        tmp32_L = left_in & 0x0000FFFF;
        tmp32_R = (right_in << 16) & 0xFFFF0000;
        tmp32 = tmp32_L | tmp32_R;
#ifdef USE_HARDWARE_ADDA8M12_C6747
        ADDA8M12->dac = tmp32;
#endif // #ifdef USE_HARDWARE_ADDA8M12_C6747
      ...
      ***********************************************************/
      ...
      // 24-Aug-20 : Svg Haltepunkt nur hier, sonst steht Unsinn in den ADC und DAC Buffers
      ADDA8M12_bufferReady = -1;
    }
  } // for (;;)
}
